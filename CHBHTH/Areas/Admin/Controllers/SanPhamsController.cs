...

{
    public class SanPhamsController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Upload(SanPham model, HttpPostedFileBase AnhSP)
        {
            if (AnhSP != null && AnhSP.ContentLength > 0)
            {
                // Đặt đường dẫn file lưu vào thư mục
                ...
                // Bạn có thể lưu đường dẫn hình ảnh vào cơ sở dữ liệu nếu cần
                model.AnhSP = fileName;
            }

            if (ModelState.IsValid)
            {
                // Thực hiện các hành động khác, ví dụ lưu model vào cơ sở dữ liệu
            }
